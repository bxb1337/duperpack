...
apktool b WhatsApp
java -jar ./uber-apk-signer-1.3.0.jar -a ./WhatsApp/dist/WhatsApp.apk && adb install WhatsApp/dist/WhatsApp-aligned-debugSigned.apk
rm -rf ./WhatsApp
adb shell am start -n com.whatsapp/.Main && sleep 120
adb pull /data/data/com.whatsapp/files/decompressed/libs.spk.zst/ . && zip -r libs.spk.zst.arm64.zip libs.spk.zst/
rm -rf ./libs.spk.zst
...
rm -rf ./WhatsApp
adb shell am start -n com.whatsapp/.Main && sleep 120
adb pull /data/data/com.whatsapp/files/decompressed/libs.spk.zst/ . && zip -r libs.spk.zst.x86.zip libs.spk.zst/
rm -rf ./libs.spk.zst
adb shell rm -rf /data/data/com.whatsapp
adb uninstall com.whatsapp
...
rm -rf ./WhatsApp
adb shell am start -n com.whatsapp/.Main && sleep 120
adb pull /data/data/com.whatsapp/files/decompressed/libs.spk.zst/ . && zip -r libs.spk.zst.x86_64.zip libs.spk.zst/
rm -rf ./libs.spk.zst
adb shell rm -rf /data/data/com.whatsapp
adb uninstall com.whatsapp
...
rm -rf ./WhatsApp
adb shell am start -n com.whatsapp/.Main && sleep 120
adb pull /data/data/com.whatsapp/files/decompressed/libs.spk.zst/ . && zip -r libs.spk.zst.armeabi-v7a.zip libs.spk.zst/
rm -rf ./libs.spk.zst
adb shell rm -rf /data/data/com.whatsapp
adb uninstall com.whatsapp
